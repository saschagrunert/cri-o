...
require (
	...
	github.com/cri-o/crio-credential-provider v0.1.0
	...
	k8s.io/cri-api v0.35.0-alpha.1
	k8s.io/cri-client v0.35.0-alpha.1
...
require (
	...
	k8s.io/apiserver v0.35.0-alpha.1 // indirect
